        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    AuthorImage = table.Column<byte[]>(type: "bytea", nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    BookImage = table.Column<byte[]>(type: "bytea", nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_GenreBooks_Books_IdBook",
                        column: x => x.IdBook,
                        principalTable: "Books",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_GenreBooks_Genres_IdGenre",
                        column: x => x.IdGenre,
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    IdUser = table.Column<int>(type: "integer", nullable: false),
                    IdHistoryOrders = table.Column<int>(type: "integer", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_WishlistBooks_Books_IdBook",
                        column: x => x.IdBook,
                        principalTable: "Books",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_WishlistBooks_Wishlists_IdWishlist",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_GenreBooks_IdBook",
                table: "GenreBooks",
                column: "IdBook");

            migrationBuilder.CreateIndex(
                name: "IX_GenreBooks_IdGenre",
                table: "GenreBooks",
                column: "IdGenre");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Orders_IdHistoryOrders",
                table: "Orders",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_WishlistBooks_IdBook",
                table: "WishlistBooks",
                column: "IdBook");

            migrationBuilder.CreateIndex(
                name: "IX_WishlistBooks_IdWishlist",
                table: "WishlistBooks",
                column: "IdWishlist");
